...
def unpack_archives(source_dir: str, target_dir: str):
...
def extract_tex_files(query: str, target_dir: str, max_results: int = 10):
    ...
    try:
        ...
        # Unpack .tex files from the downloaded tar.gz files to the target directory
        unpack_archives(temp_dir, target_dir)
...
if __name__ == "__main__":
    extract_tex_files(query="safety in AI", max_results=5, target_dir="papers_example")
